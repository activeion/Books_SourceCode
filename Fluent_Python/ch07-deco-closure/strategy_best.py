...
if __name__ == '__main__': # 阻止import运行下面的代码
    ...
    LineItem('apple', 10, 1.5)]
    print(Order(joe, banana_cart, bulk_item)) # <Order total: 30.00 due: 28.50>
    long_order = [LineItem(str(item_code), 1, 1.0) for item_code in range(10)]
    print(Order(joe, long_order, large_order)) # <Order total: 10.00 due: 9.30>
    print(Order(joe, cart, large_order)) # <Order total: 42.00 due: 42.00>
